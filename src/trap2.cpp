...
bool runTrap2(SDL_Window* window, SDL_Renderer* renderer,Uint32 gameStartTime, bool timerRunning) {
    ...
    SDL_Texture* texPit = IMG_LoadTexture(renderer, "assets/icepit.png");
    SDL_Texture* texBoulder = IMG_LoadTexture(renderer, "assets/iceboulder.png");
    SDL_Texture* texCrackedTile = IMG_LoadTexture(renderer, "assets/crackedicetile.png");
    SDL_Texture* texIce = IMG_LoadTexture(renderer, "assets/icetile.png");
    SDL_Texture* texDoorLeft = IMG_LoadTexture(renderer, "assets/icedoorleft.png");
    SDL_Texture* texVoidTile = IMG_LoadTexture(renderer, "assets/voidtile.png");
    SDL_Texture* texIceStone = IMG_LoadTexture(renderer, "assets/iceStone.png");
    SDL_Texture* texDoorRight = IMG_LoadTexture(renderer, "assets/icedoorright.png");

...
bool loadBackButtonImage() {
	backImageTexture = IMG_LoadTexture(renderer, "assets/back.png");  // Load your back.png
	return true;
}
...
void renderLeaderboardPopup(SDL_Renderer* renderer, TTF_Font* font) {
	...
	// Headers
	SDL_Color headerColor = {37, 150, 190}; // yellow-ish
	SDL_Color textColor = {255, 255, 255};
	int col1 = PopUpX + 50;
	int col2 = PopUpX + 200;
	int col3 = PopUpX + 400;
...
int main(int argc, char* argv[]) {
	...
	while (gameIsRunning) {
		...
		if (currState == 0) {
			...
			SDL_Rect textRect = {PopUpX + 50, PopUpY + 45, textSurface->w, textSurface->h};
